...
class GroupReceiptService extends RestfulService {
  constructor() {
    super("/group-receipt");
  }
...
class ReceiptService extends RestfulService {
  constructor() {
    super("/receipt");
  }
  ...
  querySelf(data: IQueryCondition) {
    const params = {
      ...data,
    };
    return ApiService.post(`${this.moduleUrl}/query-self`, params);
  }
}

const ReceiptServiceImpl = new ReceiptService();
const GroupReceiptServiceImpl = new GroupReceiptService();
