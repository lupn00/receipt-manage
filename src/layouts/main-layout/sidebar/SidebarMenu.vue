  ...
  <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
      ...
      <div
        ...
        data-kt-menu="true"
      >
        <template v-for="(item, i) in UserMenus" :key="i">
...
// import MainMenuConfig from "@/core/config/UserMenuConfig";
...
export default defineComponent({
  ...
  components: {},
  setup() {
    console.log("sidebarMenuIcons-----", sidebarMenuIcons);
    const { t, te } = useI18n();
    ...
    onMounted(async () => {
      ...
      console.log("SidebarMenu----", UserMenus.value);
